...
public interface ApiRequest {
    ...
    @FormUrlEncoded
    Call<CommonBean> userLogin(@Field("username") String strUsername, @Field("password") String strPassword, @Field("device_id") String strFCMCode, @Field("version") String strVersion);
    ...
    Call<CommonBean> userSignUp(@Field("firstname") String str1, @Field("lastname") String str2,
                                ...
                                @Field("device_id") String str7, @Field("version") String str8);

    @POST(Tags.SB_RESEND_OTP_API)
    @FormUrlEncoded
    Call<CommonBean> resendOTP(@Field("email") String str3, @Field("device_id") String str7, @Field("version") String str8, @Field("from") String str9);

    @POST(Tags.SB_SIGNUP_VERIFY_OTP_API)
    @FormUrlEncoded
    Call<CommonBean> verifySignUpOTP(@Field("email") String str3, @Field("otp") String str4, @Field("device_id") String str7, @Field("version") String str8, @Field("type") String type);

    @POST(Tags.SB_FORGOT_PASSWORD_API)
    @FormUrlEncoded
    Call<CommonBean> forgotPassword(@Field("email") String strEmail, @Field("action") String strAction);


    @POST(Tags.SB_FORGOT_PASSWORD_RESET_API)
    @FormUrlEncoded
    Call<CommonBean> resetPassword(@Field("password") String strPassword, @Field("email") String strEmail, @Field("otp") String strOTP);
    ...
    Call<TicketsBean> supportTicket(@Field("user_id") String user_id, @Field("name") String name, @Field("email") String email,
                                    @Field("subject_id") String subject_id, @Field("subject") String subject, @Field("comment") String comment, @Field("source") String source);

    @POST(Tags.SB_GAME_CATEGORY_API)
    @FormUrlEncoded
    Call<GameBean> getGames(@Field("user_id") String user_id, @Field("device_id") String device_id);

    @POST(Tags.SB_TEAMS_API)
    @FormUrlEncoded
    Call<TeamsBean> getTeams(@Field("search") String search, @Field("user_id") String user_id, @Field("game_category") String game_category, @Field("league_id") String league_id);

    @POST(Tags.SB_OPPONENT_TEAMS_API)
    @FormUrlEncoded
    Call<TeamsBean> getOpponentTeams(@Field("search") String search, @Field("user_id") String user_id, @Field("game_category") String game_category, @Field("team_id") String team_id, @Field("league_id") String league_id);

    @POST(Tags.SB_LEAGUE_API)
    @FormUrlEncoded
    Call<LeagueBean> getLeagues(@Field("search") String search, @Field("user_id") String user_id, @Field("game_category") String game_category, @Field("county") String county, @Field("team_id") String team_id);
    ...
    Call<MatchesBean> getMatches(@Field("page") String page, @Field("search") String search, @Field("user_id") String user_id,
                                 @Field("game_category") String game_category, @Field("game_id") String game_id);

    @POST(Tags.SB_MATCH_DETAIL_API)
    @FormUrlEncoded
    Call<MatchesBean> getMatchDetail(@Field("user_id") String user_id, @Field("game_id") String game_id);

    @POST(Tags.SB_DELETE_VIDEO_API)
    @FormUrlEncoded
    Call<CommonBean> deleteVideos(@Field("user_id") String user_id, @Field("game_id") String game_id, @Field("type") String type, @Field("video_id") String video_id);
    //user_id, game_id, type(1,2 for video/interview), video_id

    @POST(Tags.SB_COUNTY_API)
    @FormUrlEncoded
    Call<CountyBean> getCounty(@Field("search") String search, @Field("user_id") String user_id, @Field("game_category") String game_category);
    ...
    Call<CommonBean> makeActions1(@Field("user_id") String user_id, @Field("match_id") String match_id
            ...
            , @Field("reaction") String reaction, @Field("half") String half);
